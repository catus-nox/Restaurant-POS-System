...
<template>
  ...
  >
    ...
    <template v-for="(way, index) in payWay" :key="index">
      <div
      ...
      >
            ...
            <div class="flex w-full gap-6 p-6 py-4">
              ...
              <span>
                <template v-if="fohFetOrderDetailData">
                  <template v-if="cash">
                    $ {{ cash - fohFetOrderDetailData.totalAmount }}
                  </template>
        ...
        <template v-if="way === payWay[1]">
          <template v-for="(option, i) in payReceiptData.options" :key="i">
            <div v-show="nowClick == index + 1" class="flex flex-row gap-6 p-6 py-4">
              <UiInputOption
                :key="i"
                :id="option.name"
                :value="option.id"
              ...
              <div class="flex max-w-96 grow flex-col gap-2" v-if="i === 0">
                <UiInput
                  :id="'receipt'"
                  :is-label="false"
                  :label="'請輸入載具'"
                  ...
                  :is-validation-message="
                    validateReceipt(isValidReceipt, receipt) !== isTouchReceipt
                  "
                >
                  <template #helper></template>
                  <template #validationMessage
                    >{{ receiptValidateData.validationMessage }}
                  </template>
                </UiInput>
              </div>
              <div class="flex max-w-96 grow flex-col gap-2" v-if="i === 1">
                <UiInput
                  :id="'taxId'"
                  :is-label="false"
                  :label="'請輸入統編'"
        ...
        <template v-if="way === payWay[2]">
          <div v-show="nowClick == index + 1" class="flex flex-col">
